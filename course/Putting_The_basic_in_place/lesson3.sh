...
> heroku git:remote -a task-manager-flask-miniproject
...
gitpod /workspace/Flask-TaskManager-Miniproject $ heroku ps:scale web=1
Scaling dynos... done, now running web at 1:Free
gitpod /workspace/Flask-TaskManager-Miniproject $ 

You can see scaling dynos done.  https://devcenter.heroku.com/articles/scaling
